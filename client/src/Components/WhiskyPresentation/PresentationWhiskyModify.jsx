...
export function PresentationWhiskyModify() {
    ...
    const moveTo = () =>{
      ...
      const onSubmit = async(data) =>{
        try{
            axios.post('http://localhost:3001/whisky/ModifyPresentationWhisky',{data:data,store:userStoreIDLogged}).then((response) => {
            })
            console.log(data)
            moveTo()
        }catch(err){
