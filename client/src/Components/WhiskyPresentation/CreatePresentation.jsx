...
export function CreatePresentation() {
    ...
    const onSubmit = async(data) =>{
        ...
        try{
            axios.post('http://localhost:3001/whisky/createPresentarionWhisky',{data:data,store:userStoreIDLogged}).then((response) => {
            })
            moveTo()
        ...
        <header className="App-header">
            <div style={{ backgroundImage: 'url(require("./images/genericBackground.png"))' }}>
                <div className='container mx-auto'>
                    ...
                    <center><h1>Create new presentation</h1></center>                
